...
class getNotifier_Channel_EmailService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['notifier.channel.email'] = new \Symfony\Component\Notifier\Channel\EmailChannel(($container->privates['mailer.transports'] ?? $container->load('getMailer_TransportsService')), NULL, 'dixitsarmistha7@gmail.com');
    }
}
