...
class __TwigTemplate_f70ac1be225db6b3975d1929d19ef12361072dbb993bafe9eaa85c6bae176947 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
            // line 4
            if ((twig_length_filter($this->env, (isset($context["flash_messages"]) || array_key_exists("flash_messages", $context) ? $context["flash_messages"] : (function () { throw new RuntimeError('Variable "flash_messages" does not exist.', 4, $this->source); })())) > 0)) {
                // line 5
    ...
    {% endif %}
{% endif %}
", "@EasyAdmin/flash_messages.html.twig", "E:\\software\\xampp\\htdocs\\pimcore\\A_new\\Bakery\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\flash_messages.html.twig");
    }
}
