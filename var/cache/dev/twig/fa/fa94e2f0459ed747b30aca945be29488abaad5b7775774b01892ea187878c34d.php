...
class __TwigTemplate_a4071bb496488381dabfe6aa6ff1d50c0dfe2be4afa9cb71b9cd30d8cdfd4fc9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<header>
    <a id=\"logo\" href=\"https://api-platform.com\"><img src=\"";
        // line 53
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("bundles/apiplatform/logo-header.svg", (isset($context["assetPackage"]) || array_key_exists("assetPackage", $context) ? $context["assetPackage"] : (function () { throw new RuntimeError('Variable "assetPackage" does not exist.', 53, $this->source); })())), "html", null, true);
...
";
        ...
        if ((isset($context["showWebby"]) || array_key_exists("showWebby", $context) ? $context["showWebby"] : (function () { throw new RuntimeError('Variable "showWebby" does not exist.', 56, $this->source); })())) {
            ...
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("bundles/apiplatform/web.png", (isset($context["assetPackage"]) || array_key_exists("assetPackage", $context) ? $context["assetPackage"] : (function () { throw new RuntimeError('Variable "assetPackage" does not exist.', 57, $this->source); })())), "html", null, true);
            echo "\"></div>
...
<div class=\"swagger-ui\" id=\"formats\">
    <div class=\"information-container wrapper\">
        ...
        // line 73
        echo "            ";
        if (((isset($context["swaggerUiEnabled"]) || array_key_exists("swaggerUiEnabled", $context) ? $context["swaggerUiEnabled"] : (function () { throw new RuntimeError('Variable "swaggerUiEnabled" does not exist.', 73, $this->source); })()) && ((isset($context["active_ui"]) || array_key_exists("active_ui", $context) ? $context["active_ui"] : (function () { throw new RuntimeError('Variable "active_ui" does not exist.', 73, $this->source); })()) != "swagger_ui"))) {
            echo "<a href=\"";
        ...
        // line 74
        echo "            ";
        if (((isset($context["reDocEnabled"]) || array_key_exists("reDocEnabled", $context) ? $context["reDocEnabled"] : (function () { throw new RuntimeError('Variable "reDocEnabled" does not exist.', 74, $this->source); })()) && ((isset($context["active_ui"]) || array_key_exists("active_ui", $context) ? $context["active_ui"] : (function () { throw new RuntimeError('Variable "active_ui" does not exist.', 74, $this->source); })()) != "re_doc"))) {
            echo "<a href=\"";
        ...
        // line 76
        echo "            ";
        if ( !(isset($context["graphqlEnabled"]) || array_key_exists("graphqlEnabled", $context) ? $context["graphqlEnabled"] : (function () { throw new RuntimeError('Variable "graphqlEnabled" does not exist.', 76, $this->source); })())) {
            echo "<a href=\"javascript:alert('GraphQL support is not enabled, see https://api-platform.com/docs/core/graphql/')\">GraphiQL</a>";
        }
        // line 77
        echo "            ";
        if ((isset($context["graphiQlEnabled"]) || array_key_exists("graphiQlEnabled", $context) ? $context["graphiQlEnabled"] : (function () { throw new RuntimeError('Variable "graphiQlEnabled" does not exist.', 77, $this->source); })())) {
            echo "<a href=\"";
        ...
        // line 78
        echo "            ";
        if ((isset($context["graphQlPlaygroundEnabled"]) || array_key_exists("graphQlPlaygroundEnabled", $context) ? $context["graphQlPlaygroundEnabled"] : (function () { throw new RuntimeError('Variable "graphQlPlaygroundEnabled" does not exist.', 78, $this->source); })())) {
            echo "<a href=\"";
...
";
    ...
    public function block_stylesheet($context, array $blocks = [])
    {
        ...
        // line 9
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("bundles/apiplatform/swagger-ui/swagger-ui.css", (isset($context["assetPackage"]) || array_key_exists("assetPackage", $context) ? $context["assetPackage"] : (function () { throw new RuntimeError('Variable "assetPackage" does not exist.', 9, $this->source); })())), "html", null, true);
        echo "\">
        <link rel=\"stylesheet\" href=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("bundles/apiplatform/style.css", (isset($context["assetPackage"]) || array_key_exists("assetPackage", $context) ? $context["assetPackage"] : (function () { throw new RuntimeError('Variable "assetPackage" does not exist.', 10, $this->source); })())), "html", null, true);
        echo "\">
    ";
    ...
    public function block_javascript($context, array $blocks = [])
    {
        ...
        // line 84
        echo "    ";
        if ((((isset($context["reDocEnabled"]) || array_key_exists("reDocEnabled", $context) ? $context["reDocEnabled"] : (function () { throw new RuntimeError('Variable "reDocEnabled" does not exist.', 84, $this->source); })()) &&  !(isset($context["swaggerUiEnabled"]) || array_key_exists("swaggerUiEnabled", $context) ? $context["swaggerUiEnabled"] : (function () { throw new RuntimeError('Variable "swaggerUiEnabled" does not exist.', 84, $this->source); })())) || ((isset($context["reDocEnabled"]) || array_key_exists("reDocEnabled", $context) ? $context["reDocEnabled"] : (function () { throw new RuntimeError('Variable "reDocEnabled" does not exist.', 84, $this->source); })()) && ("re_doc" == (isset($context["active_ui"]) || array_key_exists("active_ui", $context) ? $context["active_ui"] : (function () { throw new RuntimeError('Variable "active_ui" does not exist.', 84, $this->source); })()))))) {
            // line 85
            echo "        <script src=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("bundles/apiplatform/redoc/redoc.standalone.js", (isset($context["assetPackage"]) || array_key_exists("assetPackage", $context) ? $context["assetPackage"] : (function () { throw new RuntimeError('Variable "assetPackage" does not exist.', 85, $this->source); })())), "html", null, true);
            echo "\"></script>
        <script src=\"";
            // line 86
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("bundles/apiplatform/init-redoc-ui.js", (isset($context["assetPackage"]) || array_key_exists("assetPackage", $context) ? $context["assetPackage"] : (function () { throw new RuntimeError('Variable "assetPackage" does not exist.', 86, $this->source); })())), "html", null, true);
            echo "\"></script>
    ";
        } else {
            // line 88
            echo "        <script src=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("bundles/apiplatform/swagger-ui/swagger-ui-bundle.js", (isset($context["assetPackage"]) || array_key_exists("assetPackage", $context) ? $context["assetPackage"] : (function () { throw new RuntimeError('Variable "assetPackage" does not exist.', 88, $this->source); })())), "html", null, true);
            echo "\"></script>
        <script src=\"";
            // line 89
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("bundles/apiplatform/swagger-ui/swagger-ui-standalone-preset.js", (isset($context["assetPackage"]) || array_key_exists("assetPackage", $context) ? $context["assetPackage"] : (function () { throw new RuntimeError('Variable "assetPackage" does not exist.', 89, $this->source); })())), "html", null, true);
            echo "\"></script>
        <script src=\"";
            // line 90
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("bundles/apiplatform/init-swagger-ui.js", (isset($context["assetPackage"]) || array_key_exists("assetPackage", $context) ? $context["assetPackage"] : (function () { throw new RuntimeError('Variable "assetPackage" does not exist.', 90, $this->source); })())), "html", null, true);
            echo "\"></script>
    ";
        }
    ...
    {
        return array (  275 => 90,  271 => 89,  266 => 88,  261 => 86,  256 => 85,  253 => 84,  243 => 83,  231 => 10,  227 => 9,  224 => 8,  214 => 7,  201 => 93,  199 => 83,  193 => 79,  186 => 78,  179 => 77,  174 => 76,  172 => 75,  165 => 74,  158 => 73,  156 => 72,  152 => 70,  141 => 68,  137 => 67,  128 => 60,  123 => 58,  118 => 57,  116 => 56,  110 => 53,  68 => 15,  66 => 14,  64 => 13,  61 => 12,  59 => 7,  51 => 5,  45 => 1,);
    }
...
", "@ApiPlatform/SwaggerUi/index.html.twig", "E:\\software\\xampp\\htdocs\\pimcore\\A_new\\Bakery\\vendor\\api-platform\\core\\src\\Bridge\\Symfony\\Bundle\\Resources\\views\\SwaggerUi\\index.html.twig");
    }
}
