...
class getMailer_TransportFactory_SendmailService extends App_KernelEnvDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return new \Symfony\Component\Mailer\Transport\SendmailTransportFactory(($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()), NULL, ($container->privates['monolog.logger'] ?? $container->load('getMonolog_LoggerService')));
    }
}
